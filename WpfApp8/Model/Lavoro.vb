...
Namespace Model
    Public Class Lavoro
        Inherits App.LavoroBase

        ' TODO: aggiungere le proprietà da utilizzare nel lavoro
        '       NB. LE PROPRIETA' DEVONO ESSERE PUBLIC
        '       ALTRIMENTI NON SI PUO FARE IL BINDING
        '       PER IL BINDING VANNO ANCHE DECORATE CON
